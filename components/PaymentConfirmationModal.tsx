...
const PaymentConfirmationModal: React.FC<PaymentConfirmationModalProps> = ({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={`Confirm Payment for Shipment #${shipment.id}`}
      size="lg"
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-sm text-secondary-600 dark:text-secondary-400">
          Confirm you have paid the approved fees totaling{' '}
          <strong className="text-secondary-800 dark:text-secondary-200">
            ${totalFee.toFixed(2)}
          </strong>
          . You can optionally upload a receipt for proof of payment.
        </p>
