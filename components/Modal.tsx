...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <FocusTrap active={isOpen}>
      ...
      >
        <div
          className={`bg-white dark:bg-secondary-800 rounded-xl shadow-2xl w-full ${sizeClasses[size]} transform transition-all duration-300 ease-in-out scale-95 opacity-0 animate-modal-appear`}
        >
