...
const InventoryManagementPage: React.FC = () => {
  ...
  const handleSaveItem = async () => {
    ...
    try {
      const itemToSave = {
        ...currentItem,
        quantity: currentItem.isSerialized
          ? currentItem.serialNumbers?.length || 0
          : Number(currentItem.quantity || 0),
        reorderPoint: currentItem.isSerialized
          ? 0
          : Number(currentItem.reorderPoint || 0),
      ...
      if (
        ...
        throw new Error(
          'Name, SKU, Category, and Location are required fields.'
        );
      }
        ...
        >
          ...
          <div className="pt-2">
            ...
            <p className="text-xs text-secondary-500 dark:text-secondary-400 mt-1">
              If checked, quantity is managed via individual serial numbers. Add
              serials after creating the item.
            </p>
          </div>
          ...
          <div className="pt-2">
            ...
            <p className="text-xs text-secondary-500 dark:text-secondary-400 mt-1">
              Check this to mark as aged, or items older than 365 days are
              automatically aged.
            </p>
          </div>
