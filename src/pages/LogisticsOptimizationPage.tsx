    ...
    <div className="space-y-4">
      <div>
        ...
        <input
          ...
          onChange={e =>
            setShippingForm(prev => ({ ...prev, origin: e.target.value }))
          }
      ...
      <div>
        ...
        <input
          ...
          onChange={e =>
            setShippingForm(prev => ({ ...prev, destination: e.target.value }))
          }
          className="mt-1 block w-full rounded-md border border-secondary-300 px-3 py-2 focus:border-primary-500 focus:ring-primary-500 dark:bg-secondary-700 dark:border-secondary-600"
      ...
      <div>
        ...
        <textarea
          ...
          onChange={e =>
            setShippingForm(prev => ({ ...prev, constraints: e.target.value }))
          }
          className="mt-1 block w-full rounded-md border border-secondary-300 px-3 py-2 focus:border-primary-500 focus:ring-primary-500 dark:bg-secondary-700 dark:border-secondary-600"
          rows={3}
      ...
      <button
        ...
        disabled={
          isLoading || !shippingForm.origin || !shippingForm.destination
        }
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          onChange={e =>
            setInventoryForm(prev => ({ ...prev, leadTimes: e.target.value }))
          }
          className="mt-1 block w-full rounded-md border border-secondary-300 px-3 py-2 focus:border-primary-500 focus:ring-primary-500 dark:bg-secondary-700 dark:border-secondary-600"
          rows={3}
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          onChange={e =>
            setSupplierForm(prev => ({ ...prev, supplierData: e.target.value }))
          }
          className="mt-1 block w-full rounded-md border border-secondary-300 px-3 py-2 focus:border-primary-500 focus:ring-primary-500 dark:bg-secondary-700 dark:border-secondary-600"
          rows={3}
      ...
      <div>
        ...
        <textarea
          ...
          onChange={e =>
            setSupplierForm(prev => ({ ...prev, orderHistory: e.target.value }))
          }
          className="mt-1 block w-full rounded-md border border-secondary-300 px-3 py-2 focus:border-primary-500 focus:ring-primary-500 dark:bg-secondary-700 dark:border-secondary-600"
          rows={3}
      ...
      <button
            ...
            setResults(prev => [
              ...prev,
              {
                ...
                data: {
                  ...
                  insights:
                    'Supplier A consistently delivers on time and maintains high quality.',
                },
                timestamp: new Date(),
              },
            ]);
        ...
        disabled={
          isLoading || !supplierForm.supplierData || !supplierForm.orderHistory
        }
        className="w-full bg-primary-600 text-white px-4 py-2 rounded-md hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isLoading ? (
  ...
  const renderWarehouseForm = () => (
    <div className="space-y-4">
      ...
      <button
            ...
            setResults(prev => [
              ...prev,
              {
                ...
                data: {
                  ...
                  justification:
                    'Optimized layout based on inventory density and pick times.',
                },
                timestamp: new Date(),
              },
            ]);
        ...
        disabled={
          isLoading ||
          !warehouseForm.currentLayout ||
          !warehouseForm.inventoryData
        }
        className="w-full bg-primary-600 text-white px-4 py-2 rounded-md hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isLoading ? (
        ...
        <textarea
          ...
          onChange={e =>
            setProcurementForm(prev => ({
              ...prev,
              procurementData: e.target.value,
            }))
          }
          className="mt-1 block w-full rounded-md border border-secondary-300 px-3 py-2 focus:border-primary-500 focus:ring-primary-500 dark:bg-secondary-700 dark:border-secondary-600"
          rows={3}
              ...
              ...prev,
              {
                ...
                data: {
                  insights: {
                    ...
                    recommendations: [
                      'Consider bulk purchasing for steel to reduce costs.',
                    ],
                  },
                },
                timestamp: new Date(),
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-secondary-600 dark:text-secondary-400">
          Leverage Gemini AI to optimize shipping routes, forecast inventory,
          analyze suppliers, and more.
        </p>
      </div>
