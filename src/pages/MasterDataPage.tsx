...
const MasterDataPage: React.FC = () => {
  ...
  const isLoading = useMemo(
    () => isInventoryLoading || isVendorLoading,
    [isInventoryLoading, isVendorLoading]
  );
  const currentError = useMemo(
    () => (activeTab === 'inventory' ? inventoryError : vendorError),
    [activeTab, inventoryError, vendorError]
  );
  ...
  const handleInputChange = (
    ...
    setEditingItem(prev => {
      ...
      if (isCheckbox) finalValue = checked;
        ...
        finalValue = value.split(',').map(p => p.trim());
    ...
    if (isLoading)
      return (
        <div className="flex justify-center items-center h-48">
          ...
          <p className="ml-3">Loading {activeTab}...</p>
        </div>
      );
      ...
      case 'vendors':
        return (
          <Table<Vendor>
            ...
            data={filteredData as Vendor[]}
            actions={renderActions}
          />
        );
      case 'locations':
        return (
          <p className="text-secondary-600 dark:text-secondary-400 py-8 text-center">
            Locations master data management coming soon.
          </p>
        );
      default:
        return null;
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label
                htmlFor="inventory-reorderPoint"
                className="block text-sm font-medium text-secondary-700 dark:text-secondary-300"
              >
                Reorder Point
              </label>
          ...
          <div>
            <label
              htmlFor="inventory-isSerialized"
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label
                htmlFor="vendor-lastCommunicationDate"
                className="block text-sm font-medium text-secondary-700 dark:text-secondary-300"
              >
                Last Communication
              </label>
          ...
          <div>
            <label
              htmlFor="vendor-performanceScore"
              className="block text-sm font-medium text-secondary-700 dark:text-secondary-300"
            >
    ...
    >
      <div className="mb-4 border-b border-secondary-300 dark:border-secondary-700">
        <nav className="-mb-px flex space-x-6" aria-label="Tabs">
          {(['inventory', 'vendors', 'locations'] as MasterDataType[]).map(
            tab => (
              <button
                key={tab}
                onClick={() => {
      ...
      <div className="mb-4">
        <label htmlFor="search-master-data" className="sr-only">
          Search {activeTab}
        </label>
        <input
        ...
        >
          ...
          <div className="flex justify-end space-x-3 pt-4">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-secondary-700 bg-secondary-100 rounded-md"
              disabled={isSaving}
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-md disabled:opacity-50"
              disabled={isSaving}
            >
