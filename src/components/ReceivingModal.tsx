        ...
        try {
          ...
          const itemsToReceive: ReceivingItemState[] = fullAsn.items.map(
            (item: any) => {
              ...
              initialStatuses[item.inventoryItemId] = {
                isLoading: false,
                error: null,
              };
              return {
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-sm text-secondary-600 dark:text-secondary-400">
          Enter received quantities for each item. Scan or enter serial numbers
          for serialized products. Items will be added to inventory and any
