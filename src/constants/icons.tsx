...
export const ChatIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroChatBubbleLeftEllipsisIcon {...props} />
);
export const SettingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroCog6ToothIcon {...props} />
);
export const SunIconSolid: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroSunIcon {...props} />
);
export const MoonIconSolid: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroMoonIcon {...props} />
);
...
export const WarningIcon: React.FC<HeroIconProps> = props => (
  <HeroExclamationTriangleIcon {...props} />
);

export const SuccessIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroCheckCircleIcon {...props} />
);
export const InfoIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroInformationCircleIcon {...props} />
);
export const Bars3Icon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroBars3Icon {...props} />
);
export const SerialIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroTagIcon {...props} />
);
export const CheckBadgeIcon: React.FC<
  React.SVGProps<SVGSVGElement>
> = props => <HeroCheckBadgeIcon {...props} />;
export const ChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
  <HeroChartBarIcon {...props} />
);
